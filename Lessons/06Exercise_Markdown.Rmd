...
## Report the summary
```{r}
#nutrient_data_tn # does not look professional
```

Use the knitr command

```{r create tables, echo=FALSE}

knitr::kable(nutrient_data_tn, caption = "Summary of Total Nitrogen") # very professional

# adding another table (number automatically add up)
