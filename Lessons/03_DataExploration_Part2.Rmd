...
)#character vs factor: factors are grouping variables

## -Initial Exploration-

#View(USGS.flow.data) #would not knit if have this
...
# ggplot was imported when importing tidyverse
# aes: aesthetic 
# levels(discharge.mean.approval), found 4 levels " " (blank), "A", "A:e", "P"
```
